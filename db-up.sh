...
echoCmd "ssh $remote_ssh \"mongodump --authenticationDatabase admin --archive --uri=$server_uri >> $server_bak\"" &&

ssh $remote_ssh "mongodump --authenticationDatabase admin --archive --uri=$server_uri >> $server_bak" &&
